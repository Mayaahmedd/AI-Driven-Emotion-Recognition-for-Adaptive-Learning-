"""
Oversampled training CSV builder for exp41.

Identical rule to exp38 / exp40-C so the training-set composition is
held fixed and exp41 vs exp40-C differs only in the training-time
interventions (EMA, cosine LR with warmup, optional top-3 ensemble).
"""
...
OUT_DIR = Path("/kaggle/working/FER_Project/processed_exp41")
OUT_DIR.mkdir(parents=True, exist_ok=True)
OUT_CSV = OUT_DIR / "train_multilabel_exp41_oversampled.csv"
