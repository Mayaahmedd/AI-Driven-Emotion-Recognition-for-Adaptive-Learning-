"""
Model for exp40 (imbalance ablation).

Architecture is identical to exp38: ResNet50 -> SE -> 2-layer BiLSTM ->
Temporal Attention -> MLP head with 4 logits. The class is renamed only to
keep symbol space clean if exp38, exp39 and exp40 are imported together.
"""
...
class ResNet50SEBiLSTM2AttentionMultilabelExp40(nn.Module):
    def __init__(
        self,
        num_labels=4,
        pretrained=True,
