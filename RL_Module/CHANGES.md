...
Surgical API alignment with Step 1 integration script and Step 2Eù2G spec items.
...
- **Bug:** `Monitor` without `filename=` ù collision risk for parallel seeds (NEW BUG 9).
...
Scale-only bugs found via 3,000-step training, parallel-run inspection, and T1ñT13 code audit.
