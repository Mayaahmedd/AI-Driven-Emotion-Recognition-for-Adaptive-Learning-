...
from RL_Module.mdp_definition import BEST_ACTION_MAP, ID_TO_ACTION, ID_TO_EMOTION, StudentState
...
def reason_for(
    ...
    if state.knowledge < 0.3 and action == 4:
        return "Low knowledge - scaffolding basics"
    if state.knowledge > 0.7 and action == 1:
...
class Explainer:
    REASONS = {
        ("confused", "give_hint"): "Confusion detected - providing hint",
        ("confused", "explanation"): "Confusion detected - clarifying concept",
        ("confused", "strategy_guidance"): "Confusion detected - teaching strategy",
        ("frustrated", "change_pacing"): "Frustration detected - slowing pace",
        ("frustrated", "autonomy_support"): "Frustration detected - restoring agency",
        ("frustrated", "easier_question"): "Frustration detected - reducing difficulty",
        ("bored", "motivational_message"): "Boredom detected - motivating student",
        ("bored", "autonomy_support"): "Boredom detected - restoring choice",
        ("engaged", "reflection_prompt"): "High engagement - deepening thinking",
        ("engaged", "harder_question"): "High engagement - increasing challenge",
